...
public class Testing : MonoBehaviour
{
    ...
    private GenericGrid<bool> boolGrid;
    private GenericGrid<StringGridObject> stringGrid;

    private void Start()
    {
        grid = new GenericGrid<HeatMapGridObject>(20, 10, 8f, Vector3.zero, (GenericGrid<HeatMapGridObject> g, int x, int y) => new HeatMapGridObject(g, x, y));
...
public class StringGridObject
{
    ...
    private GenericGrid<StringGridObject> grid;
    private int x;
    private int y;
    ...
    public StringGridObject(GenericGrid<StringGridObject> grid, int x, int y)
    {
        this.grid = grid;
        this.x = x;
        this.y = y;
